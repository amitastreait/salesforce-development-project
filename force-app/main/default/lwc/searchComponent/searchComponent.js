...
export default class SearchComponent extends NavigationMixin(LightningElement) {
    ...
    @api searchField = 'Name'; // usefull when using the component inside flow
    ...
    connectedCallback(){
        ...
        /* check if searchField is there in fields if not then push */
        if( !this.fields.includes(this.searchField.trim()) ){
    ...
    handleSelect(event){
        ...
        this.valueName      = selectRecord[this.searchField];
